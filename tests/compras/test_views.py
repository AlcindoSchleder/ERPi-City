...
from apps.cadastro.models import Fornecedor, Produto
from apps.compras.models import OrcamentoCompra, PedidoCompra, ItensCompra
from apps.estoque.models import LocalEstoque, DEFAULT_LOCAL_ID
