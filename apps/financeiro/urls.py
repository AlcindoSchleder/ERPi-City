...
urlpatterns = [
    ...
    path(
        'lancamentos/',
        views.LancamentoListView.as_view(),
    ...
    path(
        'contareceber/listacontareceber/hoje/',
