...
urlpatterns = [
    ...
    path(
        'orcamentocompra/listaorcamentocompra/vencidos/',
    ...
    path(
        'orcamentocompra/listaorcamentocompra/hoje/',
    ...
    path(
        'pedidocompra/listapedidocompra/hoje/',
