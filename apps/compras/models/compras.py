...
from apps.vendas.models import (
    TIPOS_DESCONTO_ESCOLHAS, MOD_FRETE_ESCOLHAS, STATUS_ORCAMENTO_ESCOLHAS,
)
from apps.estoque.models import DEFAULT_LOCAL_ID
...
class ItensCompra(models.Model):
    ...
    incluir_bc_icms = models.BooleanField(
        default=False)  # incluir IPI na BC do ICMS Bi-Tributação???
