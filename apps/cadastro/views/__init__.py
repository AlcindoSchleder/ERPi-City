...
from .fornecedor import (
    AdicionarFornecedorView, FornecedoresListView, EditarFornecedorView,
)
from .transportadora import (
    AdicionarTransportadoraView, TransportadorasListView, EditarTransportadoraView,
)
from .produto import (
...
from .ajax_views import (
    InfoCliente, InfoFornecedor, InfoEmpresa, InfoTransportadora, InfoProduto,
)
