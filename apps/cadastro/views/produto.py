...
from apps.base.custom_views import (
    CustomCreateView, CustomListView, CustomUpdateView,
)
from apps.cadastro.forms import (
    ProdutoForm, CategoriaForm, UnidadeForm, MarcaForm
)
from apps.cadastro.models import (
    Produto, Categoria, Unidade, Marca, Fornecedor,
)
from apps.estoque.models import (
    ItensMovimento, EntradaEstoque, ProdutoEstocado,
)
...
class CategoriasListView(CustomListView):
    ...
    # def get_queryset(self):
    #     queryset = super(CategoriasListView, self).get_queryset()
    #     cat = ''
    #     for obj in queryset:
    #         if str(obj.id) != cat:
    #             cat = str(obj.id)
    #         if obj.id != obj.fk_categorias_id:
    #             cat += '.' + str(obj.fk_categorias_id)
