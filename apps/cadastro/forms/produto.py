...
class CategoriaForm(forms.ModelForm):
    ...
    class Meta:
        model = Categoria
        fields = ('categoria_desc', 'fk_categorias', 'class_code', 'level')
        widgets = {
            'categoria_desc': forms.TextInput(attrs={'class': 'form-control'}),
            'fk_categorias': forms.Select(attrs={'class': 'form-control'}),
        ...
        labels = {
            ...
            'fk_categorias': _('Vinculado a:'),
            'class_code': _('Código Classificado:'),
            'level': _('Nível:'),
        }
