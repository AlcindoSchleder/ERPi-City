...
class Endereco(models.Model):
    ...
    pais = models.CharField(
        max_length=32, null=True, blank=True, default='Brasil'
    )
    cpais = models.CharField(
        max_length=5, null=True, blank=True, default='1058'
    )
    ...
    uf = models.CharField(
        max_length=3, null=True, blank=True, choices=UF_SIGLA
    )
    ...
    def format_endereco_completo(self):
        return f'{self.logradouro}, {self.numero} - {self.bairro}\r\n' + \
               f'{self.municipio}, {self.uf} - {self.cep}\r\n{self.pais}'
