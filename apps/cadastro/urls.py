...
urlpatterns = [
    ...
    path(
        'outros/listamarcas/',
        views.MarcasListView.as_view(),
        name='listamarcasview'
    ),
    # cadastro/outros/editarmarca/
    path(
        'outros/editarmarca/<int:pk>',
