# Django ERP i-City [![Build Status](https://travis-ci.org/AlcindoSchleder/djangoSIGE.svg?branch=master)](https://travis-ci.org/AlcindoSchleder/djangoSIGE)
...
- [geraldo](https://github.com/AlcindoSchleder/geraldo) - Geração de PDF para pedidos de venda/compra
- [PySIGNFe](https://github.com/AlcindoSchleder/PySIGNFe) (Opcional) - Necessário para a geração de NF-e, NFC-e, comunicação com SEFAZ, geração do DANFE, etc.
...
2. Edite o conteúdo do arquivo **configs/configs.py**
...
Para relatar bugs ou fazer perguntas utilize o [Issues](https://github.com/AlcindoSchleder/djangoSIGE/issues) ou via email thiagopena01@gmail.com
